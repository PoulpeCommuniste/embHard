...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../model.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2001040
SOPC_SYSID_FLAG += --sidp=0x2001040
ELF_PATCH_FLAG  += --sidp 0x2001040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1729942845
SOPC_SYSID_FLAG += --timestamp=1729942845
ELF_PATCH_FLAG  += --timestamp 1729942845
