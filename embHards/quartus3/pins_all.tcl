...
#### LCD
    ...
    set_location_assignment PIN_A18  -to LEDS[0] ;#LCD_RESETn
	 set_location_assignment PIN_G14  -to LEDS[1] ;#LCD_CSn
	 set_location_assignment PIN_H14  -to LCD_D_Cn
	 set_location_assignment PIN_G15  -to LCD_WRn
	 set_location_assignment PIN_H15  -to LEDS[2] ;#LCD_RDn
	 set_location_assignment PIN_G13  -to LEDS[3] ;#IM0
